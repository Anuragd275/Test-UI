...
export default function AnimatedPremiumSignupPage() {
      ...
      >
        <Card className="w-full max-w-md bg-gradient-to-br from-purple-700 to-pink-600 shadow-2xl border border-white/20">
          <CardHeader className="text-center">
            <CardTitle className="text-3xl font-bold text-white mb-2">Join PriceTracker Elite</CardTitle>
          ...
          <CardContent>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.span className="space-y-2" variants={inputVariants} whileFocus="focus">
