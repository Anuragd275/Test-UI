...
import { BarChart2, ArrowRight, Mail, Lock, IndianRupee, Sparkles, Eye, EyeOff } from "lucide-react"
      ...
      >
        <Card className="w-full max-w-md bg-white/10 backdrop-blur-md shadow-2xl border border-white/20">
          <CardHeader className="text-center">
            <CardTitle className="text-3xl font-bold mb-2 text-white">Welcome Back</CardTitle>
          ...
          <CardContent>
            ...
            >
              <p className="text-xl font-semibold mb-2 text-indigo-200">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <motion.div className="space-y-2" variants={inputVariants} whileFocus="focus">
                <Label htmlFor="email" className="text-lg text-indigo-100 flex items-center">
              ...
              <motion.div className="space-y-2" variants={inputVariants} whileFocus="focus">
                <Label htmlFor="password" className="text-lg text-indigo-100 flex items-center">
          ...
          <CardFooter className="justify-center flex-col space-y-4">
            ...
            <Link href="/forgot-password" className="text-indigo-200 hover:text-white transition-colors">
